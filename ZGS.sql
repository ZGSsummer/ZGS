/*
Deployment script for ZGS_Testing
*/
...
:setvar DefaultDataPath "C:\Program Files\Microsoft SQL Server\MSSQL10.SQLMIS\MSSQL\DATA\"
:setvar DefaultLogPath "C:\Program Files\Microsoft SQL Server\MSSQL10.SQLMIS\MSSQL\DATA\"
...
BEGIN
    RAISERROR(N'You cannot deploy this update script to target ZEYON-SBS2011\SQLMIS. The database for which this script was built, ZGS_Testing, does not exist on this server.', 16, 127) WITH NOWAIT
    RETURN
END

GO

IF (@@servername != 'ZEYON-SBS2011\SQLMIS')
BEGIN
    RAISERROR(N'The server name in the build script %s does not match the name of the target server %s. Verify whether your database project settings are correct and whether your build script is up to date.', 16, 127,N'ZEYON-SBS2011\SQLMIS',@@servername) WITH NOWAIT
    RETURN
END

GO

IF CAST(DATABASEPROPERTYEX(N'$(DatabaseName)','IsReadOnly') as bit) = 1
BEGIN
...
GO
/*
The column [dbo].[Drawings].[InDatabase] is being dropped, data loss could occur.
*/

IF EXISTS (select top 1 1 from [dbo].[Drawings])
    RAISERROR ('Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
/*
The column [dbo].[GreensheetDetails].[Part] is being dropped, data loss could occur.
*/

IF EXISTS (select top 1 1 from [dbo].[GreensheetDetails])
    RAISERROR ('Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
/*
The column [dbo].[Greensheets].[Revision] is being dropped, data loss could occur.
*/

IF EXISTS (select top 1 1 from [dbo].[Greensheets])
    RAISERROR ('Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Dropping DF_Drawings_DrawingNumber...';


GO
ALTER TABLE [dbo].[Drawings] DROP CONSTRAINT [DF_Drawings_DrawingNumber];


GO
PRINT N'Dropping DF_Drawings_InDatabase...';


GO
ALTER TABLE [dbo].[Drawings] DROP CONSTRAINT [DF_Drawings_InDatabase];


GO
PRINT N'Dropping DF_Drawings_DuplicateID...';


GO
ALTER TABLE [dbo].[Drawings] DROP CONSTRAINT [DF_Drawings_DuplicateID];


GO
PRINT N'Dropping DF_Drawings_ToDelete...';


GO
ALTER TABLE [dbo].[Drawings] DROP CONSTRAINT [DF_Drawings_ToDelete];


GO
PRINT N'Dropping DF_Drawings_CustomerList_Drawing...';


GO
ALTER TABLE [dbo].[Drawings] DROP CONSTRAINT [DF_Drawings_CustomerList_Drawing];


GO
PRINT N'Dropping DF_GreensheetDetails_QtyEa...';


GO
ALTER TABLE [dbo].[GreensheetDetails] DROP CONSTRAINT [DF_GreensheetDetails_QtyEa];


GO
PRINT N'Dropping DF_GreensheetDetails_MTRs...';


GO
ALTER TABLE [dbo].[GreensheetDetails] DROP CONSTRAINT [DF_GreensheetDetails_MTRs];


GO
PRINT N'Dropping DF_GreensheetDetails_GreensheetDetails_Greensheet...';


GO
ALTER TABLE [dbo].[GreensheetDetails] DROP CONSTRAINT [DF_GreensheetDetails_GreensheetDetails_Greensheet];


GO
PRINT N'Dropping DF_Greensheets_Revision...';


GO
ALTER TABLE [dbo].[Greensheets] DROP CONSTRAINT [DF_Greensheets_Revision];


GO
PRINT N'Dropping DF_Greensheets_DateEntered...';


GO
ALTER TABLE [dbo].[Greensheets] DROP CONSTRAINT [DF_Greensheets_DateEntered];


GO
PRINT N'Dropping DF_Greensheets_QtyOrdered...';


GO
ALTER TABLE [dbo].[Greensheets] DROP CONSTRAINT [DF_Greensheets_QtyOrdered];


GO
PRINT N'Dropping DF_Greensheets_GreenSheet_Drawing1...';


GO
ALTER TABLE [dbo].[Greensheets] DROP CONSTRAINT [DF_Greensheets_GreenSheet_Drawing1];


GO
PRINT N'Dropping DF_Greensheets_Greensheet_Order...';


GO
ALTER TABLE [dbo].[Greensheets] DROP CONSTRAINT [DF_Greensheets_Greensheet_Order];


GO
PRINT N'Dropping DF_Greensheets_Rev...';


GO
ALTER TABLE [dbo].[Greensheets] DROP CONSTRAINT [DF_Greensheets_Rev];


GO
PRINT N'Dropping DF_Order_WorkOrder...';


GO
ALTER TABLE [dbo].[Order] DROP CONSTRAINT [DF_Order_WorkOrder];


GO
PRINT N'Dropping DF_Order_OrderDate...';


GO
ALTER TABLE [dbo].[Order] DROP CONSTRAINT [DF_Order_OrderDate];


GO
PRINT N'Dropping DF_Order_CustomerList_Order...';


GO
ALTER TABLE [dbo].[Order] DROP CONSTRAINT [DF_Order_CustomerList_Order];


GO
PRINT N'Dropping Greensheet_Drawing...';


GO
ALTER TABLE [dbo].[Greensheets] DROP CONSTRAINT [Greensheet_Drawing];


GO
PRINT N'Dropping Customer_Drawing...';


GO
ALTER TABLE [dbo].[Drawings] DROP CONSTRAINT [Customer_Drawing];


GO
PRINT N'Dropping GreensheetDetails_Greensheet...';


GO
ALTER TABLE [dbo].[GreensheetDetails] DROP CONSTRAINT [GreensheetDetails_Greensheet];


GO
PRINT N'Dropping Greensheet_Order...';


GO
ALTER TABLE [dbo].[Greensheets] DROP CONSTRAINT [Greensheet_Order];


GO
PRINT N'Dropping Customer_Order...';


GO
ALTER TABLE [dbo].[Order] DROP CONSTRAINT [Customer_Order];


GO
PRINT N'Altering [dbo].[CustomerList]...';
...
GO
PRINT N'Creating UK_CustomerList...';


GO
ALTER TABLE [dbo].[CustomerList]
    ADD CONSTRAINT [UK_CustomerList] UNIQUE NONCLUSTERED ([CustomerName] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);
...
CREATE TABLE [dbo].[tmp_ms_xx_Drawings] (
    ...
    [DrawingNumber]        NVARCHAR (50)  CONSTRAINT [DF_Drawings_DrawingNumber] DEFAULT ('') NOT NULL,
    [DrawingDescription]   NVARCHAR (150) NULL,
    [PartNumber]           NVARCHAR (255) NULL,
    [DuplicateID]          INT            CONSTRAINT [DF_Drawings_DuplicateID] DEFAULT ((0)) NOT NULL,
    [ToDelete]             BIT            NULL,
    [RowVersion]           TIMESTAMP      NOT NULL,
    [CustomerList_Drawing] INT            CONSTRAINT [DF_Drawings_CustomerList_Drawing] DEFAULT ((0)) NOT NULL
);

ALTER TABLE [dbo].[tmp_ms_xx_Drawings]
    ADD CONSTRAINT [tmp_ms_xx_clusteredindex_PK_Drawings] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);

IF EXISTS (SELECT TOP 1 1
           FROM   [dbo].[Drawings])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_Drawings] ON;
        INSERT INTO [dbo].[tmp_ms_xx_Drawings] ([Id], [DrawingNumber], [DrawingDescription], [DuplicateID], [ToDelete], [CustomerList_Drawing], [PartNumber])
        SELECT   [Id],
                 [DrawingNumber],
                 [DrawingDescription],
                 [DuplicateID],
                 [ToDelete],
                 [CustomerList_Drawing],
                 [PartNumber]
        FROM     [dbo].[Drawings]
        ORDER BY [Id] ASC;
...
EXECUTE sp_rename N'[dbo].[tmp_ms_xx_clusteredindex_PK_Drawings]', N'PK_Drawings', N'OBJECT';
...
GO
PRINT N'Creating UK_Drawings...';


GO
ALTER TABLE [dbo].[Drawings]
    ADD CONSTRAINT [UK_Drawings] UNIQUE NONCLUSTERED ([DrawingNumber] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);


GO
PRINT N'Starting rebuilding table [dbo].[GreensheetDetails]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_GreensheetDetails] (
    [Id]                           INT             IDENTITY (1, 1) NOT NULL,
    [ItemID]                       DECIMAL (18, 2) NULL,
    [QtyEa]                        INT             CONSTRAINT [DF_GreensheetDetails_QtyEa] DEFAULT ((0)) NOT NULL,
    [Description]                  NVARCHAR (MAX)  NULL,
    [Material]                     NVARCHAR (MAX)  NULL,
    [MTRs]                         BIT             CONSTRAINT [DF_GreensheetDetails_MTRs] DEFAULT ((0)) NOT NULL,
    [Status]                       NVARCHAR (MAX)  NULL,
    [Notes]                        NVARCHAR (MAX)  NULL,
    [PriceEach]                    DECIMAL (18, 2) NULL,
    [Supplier]                     NVARCHAR (MAX)  NULL,
    [RowVersion]                   TIMESTAMP       NOT NULL,
    [GreensheetDetails_Greensheet] INT             CONSTRAINT [DF_GreensheetDetails_GreensheetDetails_Greensheet] DEFAULT ((0)) NOT NULL
);

ALTER TABLE [dbo].[tmp_ms_xx_GreensheetDetails]
    ADD CONSTRAINT [tmp_ms_xx_clusteredindex_PK_GreensheetDetails] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);

IF EXISTS (SELECT TOP 1 1
           FROM   [dbo].[GreensheetDetails])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_GreensheetDetails] ON;
        INSERT INTO [dbo].[tmp_ms_xx_GreensheetDetails] ([Id], [QtyEa], [Description], [Material], [MTRs], [Status], [Notes], [PriceEach], [Supplier], [GreensheetDetails_Greensheet], [ItemID])
        SELECT   [Id],
                 [QtyEa],
                 [Description],
                 [Material],
                 ...
                 [PriceEach],
                 [Supplier],
                 [GreensheetDetails_Greensheet],
                 [ItemID]
        FROM     [dbo].[GreensheetDetails]
        ORDER BY [Id] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_GreensheetDetails] OFF;
    END

DROP TABLE [dbo].[GreensheetDetails];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_GreensheetDetails]', N'GreensheetDetails';

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_clusteredindex_PK_GreensheetDetails]', N'PK_GreensheetDetails', N'OBJECT';
...
GO
PRINT N'Starting rebuilding table [dbo].[Greensheets]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_Greensheets] (
    [Id]                  INT             IDENTITY (1, 1) NOT NULL,
    [DateEntered]         DATETIME        CONSTRAINT [DF_Greensheets_DateEntered] DEFAULT ((0)) NOT NULL,
    [ItemID]              DECIMAL (18, 2) NULL,
    [Rev]                 NVARCHAR (20)   CONSTRAINT [DF_Greensheets_Rev] DEFAULT ('') NOT NULL,
    [QtyOrdered]          INT             CONSTRAINT [DF_Greensheets_QtyOrdered] DEFAULT ((0)) NOT NULL,
    [LaborEach]           DECIMAL (18, 2) NULL,
    [SalesEach]           DECIMAL (18, 2) NULL,
    [ASMEEach]            DECIMAL (18, 2) NULL,
    [RowVersion]          TIMESTAMP       NOT NULL,
    [GreenSheet_Drawing1] INT             CONSTRAINT [DF_Greensheets_GreenSheet_Drawing1] DEFAULT ((0)) NOT NULL,
    [Greensheet_Order]    INT             CONSTRAINT [DF_Greensheets_Greensheet_Order] DEFAULT ((0)) NOT NULL
);

ALTER TABLE [dbo].[tmp_ms_xx_Greensheets]
    ADD CONSTRAINT [tmp_ms_xx_clusteredindex_PK_Greensheets] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);

IF EXISTS (SELECT TOP 1 1
           FROM   [dbo].[Greensheets])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_Greensheets] ON;
        INSERT INTO [dbo].[tmp_ms_xx_Greensheets] ([Id], [DateEntered], [QtyOrdered], [LaborEach], [SalesEach], [ASMEEach], [GreenSheet_Drawing1], [Greensheet_Order], [Rev], [ItemID])
        SELECT   [Id],
                 [DateEntered],
                 [QtyOrdered],
                 [LaborEach],
        ...
        FROM     [dbo].[Greensheets]
        ORDER BY [Id] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_Greensheets] OFF;
    END

DROP TABLE [dbo].[Greensheets];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_Greensheets]', N'Greensheets';

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_clusteredindex_PK_Greensheets]', N'PK_Greensheets', N'OBJECT';
...
CREATE TABLE [dbo].[tmp_ms_xx_Order] (
    [Id]                 INT           IDENTITY (1, 1) NOT NULL,
    [WorkOrder]          NVARCHAR (30) CONSTRAINT [DF_Order_WorkOrder] DEFAULT ('') NOT NULL,
    [CustomerWorkOrder]  NVARCHAR (40) NULL,
    [OrderDescription]   NVARCHAR (75) NULL,
    [OrderDate]          DATETIME      CONSTRAINT [DF_Order_OrderDate] DEFAULT ((0)) NOT NULL,
    [ShipDate]           DATETIME      NULL,
    [RowVersion]         TIMESTAMP     NOT NULL,
    [CustomerList_Order] INT           CONSTRAINT [DF_Order_CustomerList_Order] DEFAULT ((0)) NOT NULL
);
...
IF EXISTS (SELECT TOP 1 1
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_Order] ([Id], [WorkOrder], [CustomerWorkOrder], [OrderDescription], [OrderDate], [ShipDate], [CustomerList_Order])
        SELECT   [Id],
                 [WorkOrder],
                 [CustomerWorkOrder],
                 [OrderDescription],
...
GO
PRINT N'Creating UK_Order...';


GO
ALTER TABLE [dbo].[Order]
    ADD CONSTRAINT [UK_Order] UNIQUE NONCLUSTERED ([WorkOrder] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);


GO
PRINT N'Creating Greensheet_Drawing...';


GO
ALTER TABLE [dbo].[Greensheets] WITH NOCHECK
    ADD CONSTRAINT [Greensheet_Drawing] FOREIGN KEY ([GreenSheet_Drawing1]) REFERENCES [dbo].[Drawings] ([Id]) ON DELETE CASCADE ON UPDATE NO ACTION;


GO
PRINT N'Creating Customer_Drawing...';


GO
ALTER TABLE [dbo].[Drawings] WITH NOCHECK
    ADD CONSTRAINT [Customer_Drawing] FOREIGN KEY ([CustomerList_Drawing]) REFERENCES [dbo].[CustomerList] ([Id]) ON DELETE NO ACTION ON UPDATE NO ACTION;


GO
PRINT N'Creating GreensheetDetails_Greensheet...';


GO
ALTER TABLE [dbo].[GreensheetDetails] WITH NOCHECK
    ADD CONSTRAINT [GreensheetDetails_Greensheet] FOREIGN KEY ([GreensheetDetails_Greensheet]) REFERENCES [dbo].[Greensheets] ([Id]) ON DELETE CASCADE ON UPDATE NO ACTION;


GO
PRINT N'Creating Greensheet_Order...';


GO
ALTER TABLE [dbo].[Greensheets] WITH NOCHECK
    ADD CONSTRAINT [Greensheet_Order] FOREIGN KEY ([Greensheet_Order]) REFERENCES [dbo].[Order] ([Id]) ON DELETE CASCADE ON UPDATE NO ACTION;
...
ALTER TABLE [dbo].[Order] WITH NOCHECK
    ADD CONSTRAINT [Customer_Order] FOREIGN KEY ([CustomerList_Order]) REFERENCES [dbo].[CustomerList] ([Id]) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
GO
ALTER TABLE [dbo].[Greensheets] WITH CHECK CHECK CONSTRAINT [Greensheet_Drawing];

ALTER TABLE [dbo].[Drawings] WITH CHECK CHECK CONSTRAINT [Customer_Drawing];

ALTER TABLE [dbo].[GreensheetDetails] WITH CHECK CHECK CONSTRAINT [GreensheetDetails_Greensheet];

ALTER TABLE [dbo].[Greensheets] WITH CHECK CHECK CONSTRAINT [Greensheet_Order];

ALTER TABLE [dbo].[Order] WITH CHECK CHECK CONSTRAINT [Customer_Order];
